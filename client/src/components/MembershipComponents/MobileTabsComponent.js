...
const MobileTabsComponent = () => {
    return (
        <nav className="fixed bottom-0 left-0 right-0 flex items-center justify-around py-2 text-white bg-gray-900">
            ...
            <NavLink to="/login" className="flex flex-col items-center justify-center text-center">
                <LogoutButton />
