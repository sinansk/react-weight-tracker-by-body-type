...
const DiaryCardComponent = ({
  ...
  return (
    <>
      <div
        className={`${className} p-5 pt-0 mx-auto shadow-lg rounded-xl bg-white w-[600px] h-fit`}
      >
        ...
        {diaryItems ? (
              ...
              {diaryItems?.map((item, rowIndex) => (
                <tr key={rowIndex} className="">
                  ...
                  <td className="">
                    <DeleteButton
                      onClick={() =>
                        deleteDailyCalorie(item, diaryEntry, selectedDate)
                      }
                      className="m-auto "
                      size={18}
                    />
                      ...
                      <td key={item.id} className="">
                        <div className="relative">
                          <input
                            ...
                            data-unit={item.unit}
                            placeholder={
                              item.id === "calories" ? "required" : "optional"
                            }
                ...
                <td>
                  ...
                  >
                    <TbSquareRoundedCheckFilled
                      size={18}
                      className="m-auto cursor-pointer hover:text-pink-500"
                    />
                  </button>
                </td>
              </tr>
              ...
              <tfoot className="font-bold">
                <tr>
                  <td onClick={handleAddButton} colSpan={2}>
                    <span className="flex flex-row items-center justify-center px-3 py-1.5 text-pink-500 rounded-lg cursor-pointer hover:bg-gray-100">
          ...
          <>
            ...
            <button onClick={handleAddButton}>
              <span className="flex flex-row items-center justify-center px-3 py-1.5 text-pink-500 rounded-lg cursor-pointer hover:bg-gray-100">
                <IoIosAdd size={20} /> Add custom food
              </span>
            </button>
          </>
        )}
