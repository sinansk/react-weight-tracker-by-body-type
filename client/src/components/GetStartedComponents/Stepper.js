        ...
        <div className="lg:p-4 w-[80vw] lg:w-[50vw] mx-auto">
            <div className="flex items-center ">
                <div className="relative flex items-center ">
                    ...
                    <div className={`${registerStep >= 0 ? `text-cyan-400` : `text-gray-400`} stepper-text`}>STEP 1</div>
                </div>
                <div className={`${registerStep >= 1 ? `border-cyan-400` : `border-gray-400`} stepper-line `}></div>
                <div className="relative flex items-center ">
                    ...
                    <div className={`${registerStep >= 1 ? `text-cyan-400` : `text-gray-400`} stepper-text`}>STEP 2</div>
                </div>
                <div className={`${registerStep >= 2 ? `border-cyan-400` : `border-gray-400`} stepper-line`}></div>
                <div className="relative flex items-center ">
                    ...
                    <div className={`${registerStep >= 2 ? `text-cyan-400` : `text-gray-400`} stepper-text`}>STEP 3</div>
                </div>
                <div className={`${registerStep >= 3 ? `border-cyan-400` : `border-gray-400`} stepper-line `}></div>
                <div className="relative flex items-center ">
                    ...
                    <div className={`${registerStep >= 3 ? `text-cyan-400` : `text-gray-400`} stepper-text`}>Confirm</div>
                </div>
            </div>
        </div>
    );
