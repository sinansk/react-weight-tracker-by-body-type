  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen overflow-hidden lg:h-[calc(100vh-122px)]">
      ...
      <div className="h-12 mx-auto sm:w-1/2 xl:h-24">
        <div className="flex flex-col items-center justify-center mx-4 text-sm text-white border-2 border-pink-400 rounded-md xl:text-2xl bg-pink-400/60 opacity-90 xl:h-full">
