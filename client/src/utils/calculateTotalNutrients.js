export const calculateTotalNutrients = ({
  ...
  if (
    newTotalNutrient.totalFat === "0.00g" &&
    newTotalNutrient.totalCarbs === "0.00g" &&
    newTotalNutrient.totalProtein === "0.00g" &&
    newTotalNutrient.totalCalories === "0.00kcal"
  ) {
    return null;
  }
