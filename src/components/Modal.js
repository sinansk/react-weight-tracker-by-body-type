...
const Modal = forwardRef((props, ref) => {
    ...
    return createPortal(
        <>
            ...
            />
            <div
                className={`${props.styleProps} fixed sm:no-scrollbar overflow-y-scroll overflow-visible sm:overflow-scroll top-12 right-12 left-12 bottom-12  z-50 max-h-[80vh]  rounded-md border-[0.5px] bg-white dark:bg-gray-700 dark:text-slate-200 border-gray-400 shadow-lg m-auto`}
            >
                <button
                    onClick={close}
                ...
                <div className="grid w-full h-full p-10" >{props.children}</div>
            </div>
        </>,
